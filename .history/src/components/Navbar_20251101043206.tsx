...
const Navbar = () => {
  ...
  // Verde comunitario más vibrante: #22c55e (34, 197, 94) - verde más claro y llamativo
  const navBackground = useTransform(scrollY, [0, 100], ["rgba(34, 197, 94, 0)", "rgba(34, 197, 94, 0.95)"]);
